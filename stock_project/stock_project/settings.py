...
########################################################
'''
FOR ENVIRONMENT VARIABLES (API keys etc.)
...
# See https://docs.djangoprojec-t.com/en/5.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-tn8@rs3t0s-9!7@ocaz%t%ox7yrfs6g8e55j!2fkta^)@-^68l'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3', #/app/db/db.sqlite3 for production
    }
}
